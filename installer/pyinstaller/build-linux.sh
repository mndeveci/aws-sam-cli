...
../venv/bin/python -m PyInstaller --clean --log-level=DEBUG --additional-hooks-dir './installer/pyinstaller' --debug=imports ../../samcli/__main__.py 2>&1 | tee ../pyinstaller_output.log
